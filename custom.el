(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zencoding-mode yaml-mode xmlgen which-key web-mode wakatime-mode use-package undo-tree toml-mode thesaurus terraform-mode swiper sunrise-x-tabs sunrise-x-mirror sunrise-x-loop sunrise-x-checkpoints smooth-scrolling smex sass-mode rust-mode refheap rainbow-mode projectile pcre2el paren-face ox-reveal organic-green-theme openwith nlinum nginx-mode names markdown-mode magit-gh-pulls lua-mode langtool javap-mode inform7-mode ido-ubiquitous idle-highlight-mode htmlize highlight-symbol helm-swoop helm-git-grep helm-ag groovy-mode graphviz-dot-mode gradle-mode goto-last-change go-mode git-timemachine git-gutter gist flycheck floobits find-file-in-project fill-column-indicator expand-region elm-mode elisp-slime-nav dockerfile-mode django-mode company-quickhelp color-theme-sanityinc-tomorrow clj-refactor centered-window-mode beacon base16-theme auctex aggressive-indent ac-slime ac-cider)))
 '(pop-up-windows nil)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :foundry "unknown" :family "Noto Mono"))))
